...
CROSS JOIN (VALUES
  ('r0000001-0001-4000-8000-000000000001'::uuid, 'letter-recognition', 'Letter recognition', 0),
  ('r0000002-0001-4000-8000-000000000002'::uuid, 'letter-sounds', 'Letter sounds', 1),
  ('r0000003-0001-4000-8000-000000000003'::uuid, 'phoneme-matching', 'Phoneme matching', 2),
  ('r0000004-0001-4000-8000-000000000004'::uuid, 'blending-cvc', 'Blending CVC words', 3),
  ('r0000005-0001-4000-8000-000000000005'::uuid, 'segmenting', 'Segmenting simple words', 4),
  ('a0000002-0001-4000-8000-000000000002'::uuid, 'sight-words-basic', 'Sight words', 5),
  ('r0000006-0001-4000-8000-000000000006'::uuid, 'simple-sentence-reading', 'Simple sentence reading', 6)
...
FROM (VALUES
  ('r0000002-0001-4000-8000-000000000002'::uuid, 'r0000001-0001-4000-8000-000000000001'::uuid),
  ('r0000003-0001-4000-8000-000000000003'::uuid, 'r0000002-0001-4000-8000-000000000002'::uuid),
  ('r0000004-0001-4000-8000-000000000004'::uuid, 'r0000003-0001-4000-8000-000000000003'::uuid),
  ('r0000005-0001-4000-8000-000000000005'::uuid, 'r0000004-0001-4000-8000-000000000004'::uuid),
  ('a0000002-0001-4000-8000-000000000002'::uuid, 'r0000005-0001-4000-8000-000000000005'::uuid),
  ('r0000006-0001-4000-8000-000000000006'::uuid, 'a0000002-0001-4000-8000-000000000002'::uuid)
